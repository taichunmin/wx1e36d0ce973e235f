...
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([ [ 36 ], {
    102: function _(e, t, n) {
        ...
        (function(e) {
            ...
            var a = n(4), i = n(9), r = n(15), c = n(16), o = n(11), s = n(2), u = n.n(s), l = n(7), f = n(25), h = n(88), d = n(59), g = n(34), b = function b(e) {
                ...
                function t() {
                    ...
                    Object(o["a"])(this, "c90002Uuid", ""), Object(o["a"])(this, "c90003Uuid", ""), 
                    Object(o["a"])(this, "skipSendingInitPacket", !0), Object(o["a"])(this, "resumeSendingInitPacket", !0), 
                    Object(o["a"])(this, "expectedCRC", 0), Object(o["a"])(this, "imageBuf", e.from([])), 
                    Object(o["a"])(this, "total", 0), Object(o["a"])(this, "count", 0), Object(o["a"])(this, "bin_offset", 0), 
                    Object(o["a"])(this, "data", {
                                        ...
                                        var r = Object(i["a"])(Object(a["a"])().mark(function r(c) {
                                            ...
                                            return Object(a["a"])().wrap(function(r) {
                                                while (1) switch (r.prev = r.next) {
                                                  case 0:
                                                    if (f["c"].info("BLE getBLEDeviceServices:", c), o = c.services, console.log(o), 
                                                    s = o.find(function(e) {
                                                                    ...
                                                                    while (1) switch (a.prev = a.next) {
                                                                      case 0:
                                                                        ...
                                                                        s = r.characteristics.map(function(e) {
                                                                            var t = e.uuid;
                                                                            return t;
                                                                        }), s.includes(c) && s.includes(o) && (n.c90001Uuid = c, n.c90002Uuid = o), e(r), 
                                                                        a.next = 13;
                                                                        break;
                              ...
                              case 2:
                                return u.a.showLoading({
                                    ...
                                    return u.a.onBLECharacteristicValueChange(function(e) {
                                        console.log(" BLECharacteristicValueChange:收到的数据" + JSON.stringify(e), T(e.value)), 
                ...
                return Object(c["a"])(t, [ {
                        ...
                        var e = Object(i["a"])(Object(a["a"])().mark(function e(t) {
                            ...
                            return Object(a["a"])().wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                  ...
                                  case 20:
                                    return console.log("EXECUTE"), o = new ArrayBuffer(2), s = new DataView(o), s.setUint8(0, E.SELECT), 
                                    s.setUint8(1, v.DATA_OBJECT), e.abrupt("return", this.bleWriteTo90001(s, o).then(function() {
                                        return u.a.onBLECharacteristicValueChange(function(e) {
                            ...
                            return Object(a["a"])().wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                  ...
                                  case 21:
                                    ...
                                    return o = c.byteLength - i.data.offset, o < 4096 ? this.sendCreatePackage(this.formater4length(o)) : this.sendCreatePackage(this.formater4length(4096)), 
                                    e.abrupt("return");

                                  case 30:
                                    return console.log("发送通过"), this.imageBuf = this.imageBuf.slice(4096), s = new ArrayBuffer(1), 
                                    l = new DataView(s), l.setUint8(0, E.EXECUTE), e.abrupt("return", this.bleWriteTo90001(l, s).then(function() {
                                        return u.a.onBLECharacteristicValueChange(function(e) {
                                  ...
                                  case 36:
                                    return console.log("EXECUTE"), this.count != this.total ? (f = c.byteLength - this.bin_offset, 
                                    f < 4096 ? this.sendCreatePackage(this.formater4length(f)) : this.sendCreatePackage(this.formater4length(4096))) : (u.a.hideLoading(), 
                                    u.a.showToast({
                                        title: "升级成功",
                                        icon: "success"
                                  ...
                                  case 39:
                                    ...
                                    console.log("已发送crc:" + Object(d["a"])(this.imageBuf.slice(0, i.data.offset))), 
                                    this.imageBuf = this.imageBuf.slice(i.data.offset), console.log("未发送crc:" + Object(d["a"])(this.imageBuf)))), 
                                    0 != i.data.offset) {
                                        e.next = 47;
                                        break;
                                    }
                    ...
                    value: function value(e) {
                        ...
                        return a.setUint8(0, E.CREATE), a.setUint8(1, v.DATA_OBJECT), a.setUint8(2, e[0]), 
                        a.setUint8(3, e[1]), a.setUint8(4, 0), a.setUint8(5, 0), this.bleWriteTo90001(a, n).then(function(e) {
                            return u.a.onBLECharacteristicValueChange(function(e) {
                    ...
                    value: function value() {
                        ...
                        return n.setUint8(0, E.CREATE), n.setUint8(1, v.COMMAND_OBJECT), n.setUint8(2, 143), 
                        n.setUint8(3, 0), n.setUint8(4, 0), n.setUint8(5, 0), this.bleWriteTo90001(n, t).then(function(t) {
                    ...
                    value: function() {
                        var e = Object(i["a"])(Object(a["a"])().mark(function e(t, n) {
                            var i, r, c, o, s, f, h, d, g, b, v, p, w, O = this;
                            return Object(a["a"])().wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                  case 0:
                                    if (l["a"].device) {
                                  ...
                                  case 6:
                                    ...
                                    for (f in c = n + C > r ? r - n : C, o = new Uint8Array(t, n, c), s = "", o) h = o[f], 
                                    h < 16 && (s += "0"), s += h.toString(16);
                                    ...
                                    return b = new ArrayBuffer(1), v = new DataView(b), v.setUint8(0, E.CALCULATE_CHECKSUM), 
                            ...
                            return Object(a["a"])().wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                  ...
                                  case 5:
                                    ...
                                    for (h in o = n + C > r ? r - n : C, s = new Uint8Array(t, n, o), f = "", s) d = s[h], 
                                    d < 16 && (f += "0"), f += d.toString(16);
                                    ...
                                    return t = new ArrayBuffer(1), v = new DataView(t), v.setUint8(0, E.CALCULATE_CHECKSUM), 
    ...
    516: function _(e, t, n) {
        "use strict";
        n.r(t);
        var a = n(8), i = (n(54), n(23)), r = (n(48), n(19)), c = n(4), o = n(9), s = n(13), u = n(1), l = n(5), f = n(26), h = n(57), d = n.n(h), g = (n(493), 
        n(102)), b = n(2), E = n.n(b), v = n(34), C = n(0), p = function p() {
    ...
    59: function _(e, t, n) {
        "use strict";
        var a = n(20), i = a["Buffer"].from && a["Buffer"].alloc && a["Buffer"].allocUnsafe && a["Buffer"].allocUnsafeSlow ? a["Buffer"].from : function(e) {
            return new a["Buffer"](e);
        }, r = i, c = function c(e, t) {
