...
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([
  [38], {
    ...
    505: function _(e, t, n) {
      ...
      function d(e) {
        var t = e.value,
          _e$accordion = e.accordion,
          n = _e$accordion === void 0 ? !1 : _e$accordion,
          _e$border = e.border,
          c = _e$border === void 0 ? !0 : _e$border,
          d = e.onOpen,
          u = e.onClose,
          b = e.onChange,
          j = e.style,
          O = e.className,
          h = e.children,
          m = Object(s["a"])(e, ["value", "accordion", "border", "onOpen", "onClose", "onChange", "style", "className", "children"]),
          _Object = Object(i["useState"])([]),
          _Object2 = _slicedToArray2(_Object, 2),
          g = _Object2[0],
          p = _Object2[1],
          x = Object(i["useCallback"])(function() {
            var e = [];
            if (t && !Array.isArray(t)) e.push(t.toString());
      ...
      function g(e) {
        var t = e.size,
          _e$name = e.name,
          n = _e$name === void 0 ? null : _e$name,
          _e$title = e.title,
          c = _e$title === void 0 ? "" : _e$title,
          _e$value = e.value,
          d = _e$value === void 0 ? "" : _e$value,
          u = e.icon,
          g = e.label,
          _e$disabled = e.disabled,
          p = _e$disabled === void 0 ? !1 : _e$disabled,
          _e$clickable = e.clickable,
          x = _e$clickable === void 0 ? !1 : _e$clickable,
          _e$border2 = e.border,
          f = _e$border2 === void 0 ? !0 : _e$border2,
          _e$isLink = e.isLink,
          v = _e$isLink === void 0 ? !0 : _e$isLink,
          y = e.renderTitle,
          N = e.renderIcon,
          T = e.renderRightIcon,
          k = e.renderValue,
          ...
          w = e.isOpen,
          R = e.handleToggle,
          A = Object(s["a"])(e, ["size", "name", "title", "value", "icon", "label", "disabled", "clickable", "border", "isLink", "renderTitle", "renderIcon", "renderRightIcon", "renderValue", "style", "className", "children", "index", "isOpen", "handleToggle"]),
          _Object3 = Object(i["useState"])("auto"),
          _Object4 = _slicedToArray2(_Object3, 2),
          E = _Object4[0],
          L = _Object4[1],
          _Object5 = Object(i["useState"])(!1),
          _Object6 = _slicedToArray2(_Object5, 2),
          P = _Object6[0],
          z = _Object6[1],
          _Object7 = Object(i["useState"])(m++),
          _Object8 = _slicedToArray2(_Object7, 1),
          F = _Object8[0],
          J = Object(i["useRef"])(null),
          _Object9 = Object(i["useState"])(-1),
          _Object10 = _slicedToArray2(_Object9, 2),
          M = _Object10[0],
          V = _Object10[1],
          q = Object(i["useRef"])(!0);
        Object(i["useEffect"])(function() {
          ...
          -1 !== M ? (J.current && clearTimeout(J.current), w ? (L(M + "px"), q.current = !1, J.current = setTimeout(function() {
            L("auto");
